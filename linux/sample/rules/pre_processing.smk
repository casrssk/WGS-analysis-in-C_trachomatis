...
################################################################
rule fastqc1:
	input:r1="results/ct_fastq/{sample}_1.fastq", r2="results/ct_fastq/{sample}_2.fastq"
...
###################################################################################################
rule fastqc2:
	input:r1="results/normalized/{sample}.norm_1.fastq", r2="results/normalized/{sample}.norm_2.fastq"
